...
notification = ['Администрация скоро рассмотрит ваш вопрос 😌', 'Не переживайте, вам скоро ответят 🙂', 'Интересно.. Уверен, вам скоро ответят (помощник 🤖)']
answers = {}
answers[frozenset({'справку', 'заказать'})] = 'Для этого есть деканат - закажите справку там, позвонив по телефону, который вы можете найти на нашем сайте: https://vsuet.ru/sveden/struct'
answers[frozenset({'справку', 'достать'})] = 'Для этого есть деканат - закажите справку там, позвонив по телефону, который вы можете найти на нашем сайте: https://vsuet.ru/sveden/struct'
answers[frozenset({'справку', 'взять'})] = 'Для этого есть деканат - закажите справку там, позвонив по телефону, который вы можете найти на нашем сайте: https://vsuet.ru/sveden/struct'
