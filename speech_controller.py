...
"Мое расписание" - Если ты студент, то у тебя обязательно должно быть расписание! - Так вот этот пункт тебе точно будет полезен, т.к. выведет актуальный список предметов на любой день!
...
Не нашел ответа? Переходи в раздел для студентов, там тебе точно ответят!'''
