...
greeting_massage = '\nТебя приветствует онлайн-помощник ВГУИТ. Я отвечу на вопросы абитуриента и помогу с ответом на другие. Если ты интерисуешься поступлением в наш университет, то есть специальный каталог, который тебе поможет. Для работы с ним поменяй режим работы командой "/switch"'
requests_time = {}
