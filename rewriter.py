...
# Ключевые слова
words_list = {'ку':0, 'привет':0, 'эй':0, 'hello':0, 'hi':0, 'hey':0,
              'пока':1, 'прощай':1, 'до завтра':1, 'до свидания':1, 'до свиданья':1
...
def rewriter(text):
    ...
    key_list = words_in_ids(words) # Определяет ключевые слова в массиве со словами
    out = [words, key_list] #Массив вывода
    if out != [[], []]:
        return out
    else:
        return [['invalidvalue'], []]
